...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '69607e8a-6c9e-407b-937a-b1ee0fcd7e15' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('9c9fef06-3300-4107-a4f6-b5731f20b892');
      cy.get(`[data-cy="name"]`).should('have.value', '9c9fef06-3300-4107-a4f6-b5731f20b892');
